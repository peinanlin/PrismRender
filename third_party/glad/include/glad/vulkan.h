 ...
 *
 * Commandline:
 *    --api='vulkan=1.3' --extensions='VK_EXT_debug_report,VK_KHR_acceleration_structure,VK_KHR_deferred_host_operations,VK_KHR_portability_enumeration,VK_KHR_ray_query,VK_KHR_ray_tracing_pipeline,VK_KHR_surface,VK_KHR_swapchain' c --header-only
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.3&extensions=VK_EXT_debug_report%2CVK_KHR_acceleration_structure%2CVK_KHR_deferred_host_operations%2CVK_KHR_portability_enumeration%2CVK_KHR_ray_query%2CVK_KHR_ray_tracing_pipeline%2CVK_KHR_surface%2CVK_KHR_swapchain&generator=c&options=HEADER_ONLY
 *
 */
